...
const Manager = () => {
  ...
  return (
    <>
      ...
      <div className="absolute inset-0 -z-10 h-full w-full080800a_1px,transparent_ bg-green-50 bg-[linear-gradient(to_right,#81px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]"><div class="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-green-400 opacity-20 blur-[100px]">
      </div></div>
